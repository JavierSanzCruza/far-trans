...
class BasicKPIGenerator(KPIGenerator):
    ...
    def compute(self):
        ...
        for asset in assets:
            ...
            asset_time_series_df = avg_price(asset_time_series_df)
            ...
            asset_time_series_df = momentum(asset_time_series_df)
            asset_time_series_df = rate_of_change(asset_time_series_df)
            ...
            asset_time_series_df = sharpe(asset_time_series_df)
            asset_time_series_df = min_max(asset_time_series_df)
